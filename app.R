      ...
      tabPanel(
        ...
        div(
          div(
            ...
            a(
              href = "https://www.youtube.com/@atltl",
              icon("youtube"),
              "Mi Canal",
              target = "_blank"
            ),
            br(),
            a(
              href = "https://www.linkedin.com/in/atila-orlov/" ,
              icon("linkedin"),
              "Mi Perfil",
              target = "_blank"
            ),
            br(),
            a(
              href = "https://github.com/tlachinolli/fechner",
              icon("github"),
              "Código Fuente",
              target = "_blank"
            ),
            br(),
            h4("Proceso de creación -explicado paso a paso- de esta aplicación:"),
            a(
              href = "https://youtu.be/NUiHvy02AcE",
              icon("youtube"),
              "Prueba de Fechner: Rectángulos Áureos - Parte 1",
              target = "_blank"
            ),
            br(),
            a(
              href = "https://youtu.be/1Uzbqu7q6Jk",
              icon("youtube"),
              "Prueba de Fechner: Rectángulos Áureos - Parte 2",
              target = "_blank"
            ),
            br(),
            HTML(
              '<center><img src="atltl_logo.gif", height = "80px", width = "120px"></center>'
            ),
